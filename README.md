...
Place the code in a convenient location on your system and use *perl pgm.pl* at the command line to run. Use cpanm or MCPAN to install any needed perl modules. Use each program's *-h* option to display it's usage text. All programs are provided as-is and function as described. You may need to modify them for the needs of your operating environment.
